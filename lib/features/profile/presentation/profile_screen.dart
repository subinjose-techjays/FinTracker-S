...
import 'package:fin_tracker/features/profile/di/profile_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Profile', // Changed from AppStrings.dashboardTitle
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              try {
                final signOutUseCase = ref.read(profileSignOutUseCaseProvider);
